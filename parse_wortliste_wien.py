...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--oesterreich_gernder_liste", type=str, required=False, nargs='?', default="worttabelle.csv", help = "Österreichische Genderliste")
    parser.add_argument("-l", "--liste", type=str, required=False, nargs='?', default="liste.txt", help = "Liste mit Wörtern, die zu Gendern sind")
    parser.add_argument("-w", "--woerterbuch", type=str, required=False, nargs='?', default = "gender_liste.dic", help = "Wöterbuch Name zum Speichern")
    parser.add_argument("-f", "--fehler-woerterbuch", type=str, required=False, nargs='?', default = "fehler_woerter.txt", help = "Wöterbuch mit Wörtern, die nicht verarbeitet werden können")
    ...
    print("{} Wörter erfolgreich verarbeitet. {} Fehler. {} Österreichischer Dialekt".format(gender.sucessfull_words, gender.failed_words, gender.dialect_words))
